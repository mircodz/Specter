...
/// for any T, enabling both <c>_</c> (via <c>using static Mokk.Wildcard</c>) and <c>Any</c> usage.
/// </summary>
public sealed class Wildcard
{
    private Wildcard() { }

    /// <summary>Match-any shorthand. Use via <c>using static Mokk.Wildcard</c>.</summary>
